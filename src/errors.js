...
export const InvalidAddressError = (value) => {
  var errObj = {
    name: "this.name",
...
export const InvalidStringError = (value) => {
  var errObj = {
    name: "this.name",
...
export const InvalidNumberError = (value) => {
  var errObj = {
    name: "this.name",
    code: ERR_INVALID_ADDRESS,
...
export const InvalidBooleanError = (value) => {
  var errObj = {
    name: "this.name",
...
export const InvalidBytesError = (value) => {
  var errObj = {
    name: "this.name",
...
export const InvalidSizeError = (value) => {
  var errObj = {
    name: "this.name",
...
export const InvalidLargeValueError = (value) => {
  var errObj = {
    name: "this.name",
...
export const InvalidUnsignedIntegerError = (value) => {
  var errObj = {
    name: "this.name",
...
export const NibbleWidthError = (value) => {
  var errObj = {
    name: "this.name",
...
export const HexProcessingError = (value) => {
  var errObj = {
    name: "this.name",
...
export const AbiError = (value) => {
  var errObj = {
    name: "this.name",
    code: ERR_INVALID_TYPE_ABI,
    message: `Invalid value given "${value}". Error: invalid abi type.`,
    cause: "this.cause"
  }
  return errObj
}

export const TypeError = (value) => {
  var errObj = {
    name: "this.name",
...
export const PrivateKeyLengthError = (value) => {
  var errObj = {
    name: "this.name",
    code: ERR_INVALID_TYPE,
    message: `Invalid value given "${value}". Error: invalid type.`,
...
export const InvalidPrivateKeyError = (value) => {
  var errObj = {
    name: "this.name",
    code: ERR_INVALID_TYPE,
    message: `Invalid value given "${value}". Error: invalid type.`,
...
export const KeyStoreVersionError = (value) => {
  var errObj = {
    name: "this.name",
    code: ERR_INVALID_TYPE,
    message: `Invalid value given "${value}". Error: invalid type.`,
 ...
 export const PBKDF2IterationsError = (value) => {
   var errObj = {
     name: "this.name",
     code: ERR_INVALID_TYPE,
     message: `Invalid value given "${value}". Error: invalid type.`,
 ...
 export const TransactionSigningError = (value) => {
   var errObj = {
     name: "this.name",
     code: ERR_INVALID_TYPE,
     message: `Invalid value given "${value}". Error: invalid type.`,
 ...
 export const UndefinedRawTransactionError = (value) => {
   var errObj = {
     name: "this.name",
     code: ERR_INVALID_TYPE,
     message: `Invalid value given "${value}". Error: invalid type.`,
...
export const InvalidKdfError = (value) => {
  var errObj = {
    name: "this.name",
    code: ERR_INVALID_TYPE,
    message: `Invalid value given "${value}". Error: invalid type.`,
...
export const KeyDerivationError = (value) => {
  var errObj = {
    name: "this.name",
    code: ERR_INVALID_TYPE,
    message: `Invalid value given "${value}". Error: invalid type.`,
...
export const InvalidPasswordError = (value) => {
  var errObj = {
    name: "this.name",
    code: ERR_INVALID_TYPE,
    message: `Invalid value given "${value}". Error: invalid type.`,
...
export const IVLengthError = (value) => {
  var errObj = {
    name: "this.name",
    code: ERR_INVALID_TYPE,
    message: `Invalid value given "${value}". Error: invalid type.`,
...
export const InvalidSignatureError = (value) => {
  var errObj = {
    name: "this.name",
    code: ERR_INVALID_TYPE,
    message: `Invalid value given "${value}". Error: invalid type.`,
